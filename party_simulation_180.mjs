...
const PHASES = [
  { name: 'arrivée',     durationMin: 90,  bpmRange: [70, 100],  energyRange: [1, 3],
    genres: ['Ambient','Chill','Jazz','COCOVARIET','R&B','Pop'] },
  { name: 'ambiance',    durationMin: 75,  bpmRange: [90, 115],  energyRange: [3, 5],
    genres: ['Pop','R&B','Disco','House','COCOVARIET','Afro','Latin','Folk, World, & Country'] },
  { name: 'groove',      durationMin: 90,  bpmRange: [110, 125], energyRange: [5, 7],
    genres: ['House','Disco','Hip-Hop','Pop','Latin','Reggaeton','Afro','R&B'] },
  { name: 'montée',      durationMin: 75,  bpmRange: [120, 130], energyRange: [7, 8],
    genres: ['House','Electro','Disco','Pop','Latin'] },
  { name: 'apogée',      durationMin: 305,  bpmRange: [125, 145], energyRange: [8, 10],
    genres: ['House','Electro','Pop','Latin','Reggaeton'] },
  { name: 'redescente',  durationMin: 90,  bpmRange: [95, 122],  energyRange: [3, 6],
    genres: ['House','Disco','Pop','Chill','R&B','Ambient'] },
  // Second arc (shorter)
  { name: 'groove²',     durationMin: 45,  bpmRange: [110, 125], energyRange: [5, 7],
    genres: ['House','Disco','Hip-Hop','Pop','Latin','Afro'] },
  { name: 'montée²',     durationMin: 45,  bpmRange: [120, 130], energyRange: [7, 8],
    genres: ['House','Electro','Disco'] },
  { name: 'apogée²',     durationMin: 45,  bpmRange: [125, 145], energyRange: [8, 10],
    genres: ['Electro','House'] },
  { name: 'closing',     durationMin: 30,  bpmRange: [85, 115],  energyRange: [2, 5],
