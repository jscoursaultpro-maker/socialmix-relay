...
import userParticipationsRouter from './routes/user-participations.js';
...
// \u2605 FallbackHash normalization (aligne iOS DJBrain normalizeTitle 22/08/2026)
// Format canonique : title/artist normalises en minuscules alphanumeriques, SANS espaces.
// Ex: "The Rapture Pt. III" - "&ME & Black Coffee" \u2192 "theraptureptiii_meblackcoffee"
// Cutover complet 01/09/2026 (chantier normalize alignment) : legacy avec-espaces supprime,
// BDD 100% migree (2886 tracks), tous les writes utilisent ce format.
...
app.use('/api/user/participations', userParticipationsRouter);
